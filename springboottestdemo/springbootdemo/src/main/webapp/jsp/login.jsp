                            ...
                            <div class="widget-body">
                                <div class="widget-main">
                                            ...
                                            <div class="clearfix">
                                                <label class="inline">
                                                    ...
                                                    <%--<ul class="dropdown-menu dropdown-info pull-right">--%>
                                                        <%--<c:forEach items="${dicModelList}" var="dic">--%>
                                                            <%--<li>--%>
                                                                <%--<a>${dic.name}</a>--%>
                                                            <%--</li>--%>
                                                        <%--</c:forEach>--%>
                                                    <%--</ul>--%>
                                                    <select class="btn-primary" id="form-field-select-1" name="loginType">
                                                    <c:forEach items="${dicModelList}" var="dic">
                                    ...
                                    <div class="social-or-login center">
                                        <span class="bigger-110">或者用其他登录</span>
                                    </div>
                                            ...
                                            <label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="password" class="form-control"
                                                                   placeholder="确认密码" name="paw2"/>
															<i class="icon-retweet"></i>
														</span>
                                            </label>

                                            <label class="block">
                                                <input type="checkbox" class="ace" name="ok"/>
                                                <span class="lbl">
															我接受
															<a href="#">用户协议</a>
														</span>
